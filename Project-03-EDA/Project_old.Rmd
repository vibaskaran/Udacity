...
```{r More precise look at quality column, echo=FALSE, message=FALSE, warning=FALSE, packages}
table(df$quality)
```
...
```{r Data Exploration, echo=FALSE, message=FALSE, warning=FALSE, packages }
library(ggplot2)
library(GGally)
library(gridExtra)
...
```{r Box Plot, echo=FALSE, message=FALSE, warning=FALSE, packages }
...
```{r volatile acidity, echo=FALSE, message=FALSE, warning=FALSE, packages}
ggplot(data=df, aes(x=volatile.acidity)) + geom_histogram(aes(fill=..count..), binwidth=0.02)
```

Look at relationship with quality.

```{r relationship with quality, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r acidity variables with quality, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r next feature from white wine dataset, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r no additional information about patterns, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r determine some linear separation, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r Move to next variable - chlorides, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r patterns discovery except few outliers for wine with quality 3, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r patterns discovery for wine with quality 3 0.95 quantile, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r Plot Two, warning=FALSE, message=FALSE}
...
```{r Plot Three, warning=FALSE, message=FALSE}
ggplot(aes(x=alcohol, y=chlorides, color = quality.factor), data = df) + geom_point() + 
