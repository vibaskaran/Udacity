...
setwd("~/GitHub/Udacity/Project3/lesson6")
library(ggplot2)
library(ggthemes)
...
clarity and color are related to price. carat and x,y,z are correlated with price.
...
head(sort(table(diamonds$caret),decreasing = T))
